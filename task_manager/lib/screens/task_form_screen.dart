...
class _TaskFormScreenState extends State<TaskFormScreen> {
  ...
  // NOVO: Editar filtros da foto existente
  Future<void> _editPhotoFilters() async {
    if (_photoPath == null) return;

    final filteredPath = await Navigator.push<String>(
      context,
      MaterialPageRoute(
        builder: (context) => PhotoFilterScreen(imagePath: _photoPath!),
      ),
    );

    if (filteredPath != null && mounted) {
      setState(() => _photoPath = filteredPath);
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const Spacer(),
                        if (_photoPath != null) ...[
                          // BOTÃO EDITAR FILTROS - NOVO
                          TextButton.icon(
                            onPressed: _editPhotoFilters,
